...
export default class AboutMe extends Component {
  render() {
    return (
      ...
      <ScrollView style={{ width: Common.window.width, height: Common.window.height, marginTop: 0, backgroundColor: 'rgba(240,240,240,0.9)' }}>
        <Image
          ...
          style={{
            ...
            <Image
                source={require('./Swiper/img/1.jpg') }
                style={{ marginTop: 10, marginLeft: 30, width: 50, height: 50, position: 'absolute' }}/>
          <Text style={styles.welcome}>
            ReacNative
          </Text>
          <Text style={{ position: 'absolute', marginTop: 100, marginLeft: 30, color: 'white' }}>
            普通会员
          </Text>
        ...
        <Text style={{marginTop: 250,  width: Common.window.width, height: 40, position: 'absolute', padding: 10, fontSize: 18, backgroundColor: 'white' }}>
          我的订单
        </Text>
        <Text style={{color:"white", position: 'absolute', padding: 10, fontSize: 18,marginTop:17, marginLeft: Common.window.width - 30 }}>
           {/*>*/}
        </Text>
        ...
        <Text style={{ marginTop: 132, width: Common.window.width, height: 40, position: 'absolute', padding: 10, fontSize: 18, backgroundColor: 'white' }}>
          我的钱包
        </Text>
        ...
        <TouchableOpacity style={{ marginTop: 10, flexDirection: 'row', alignItems: 'center', height: 50, position: 'relative', backgroundColor: 'white' }}activeOpacity={0.75}>
          ...
          <Text style={{ position: 'absolute', padding: 12, fontSize: 18, marginLeft: Common.window.width - 30 }}>
            >
          </Text>

        </TouchableOpacity>

        <TouchableOpacity style={{ marginTop: 3, flexDirection: 'row', alignItems: 'center', height: 50, position: 'relative', backgroundColor: 'white' }}activeOpacity={0.75}>
          <Image
